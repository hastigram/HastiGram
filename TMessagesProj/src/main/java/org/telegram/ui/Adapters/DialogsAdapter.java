...
public class DialogsAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<TLRPC.TL_dialog> getDialogsArray() {
        ...
        if (dialogsType == 0) {
            ...
            Log.i("TAG", "getDialogsArray: 20");
            sortDefault(MessagesController.getInstance().MydialogsChannels);
            Log.i("TAG", "getDialogsArray: "+MessagesController.getInstance().MydialogsChannels.size());
            return MessagesController.getInstance().MydialogsChannels;
        }
        //
        return null;
    }
